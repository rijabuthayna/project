...
<form method='POST' action="AddSectionFormScript.php" > 
<input type='hidden' name='Cnumber' value= <?php echo "'".$_POST['Cnumber']."'"; ?>>
Section key:
<input type="text" style="height:25px;" name="Skey"> 
<br/>
Add Deadline: 
<input type="text" style="height:25px;" name="AddDeadline" value="YYYY-MM-DD"> 
<br/>
Student Capacity: 
...
<br/>
Section StartDate: <input type="text" style="height:25px;" name="SectionStart" value="YYYY-MM-DD"> 
<br/>
Section EndDate: <input type="text" style="height:25px;" name="SectionEnd" value="YYYY-MM-DD"> 
<br/>
Drop Deadline: <input type="text" style="height:25px;" name="DropDead" value="YYYY-MM-DD"> 
<br/>
Semester: <input type="text" style="height:25px;" name="Semester"> 
<br/>
