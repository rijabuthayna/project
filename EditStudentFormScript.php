...
$err12=true;
$err12S="Andrew ID does not exist, ";}
}
if ($err01  or $err02 or $err03 or $err04 or $err05 or $err06 or $err08 or $err09 or $err10 or $err11 or $err12 or $err13){
echo '<script type="text/javascript">
alert("'.$err01S.$err02S.$err03S.$err04S.$err05S.$err06S.$err08S.$err09S.$err10S.$err11S.$err12S.$err13S.'");
location="http://www.dbproject14.net/Project/AdminViewStudents.php";
</script>';

}
else{
//now we can safely update the student

$sql2 = "UPDATE student 
SET Sfirstname= '$firstname' , Slastname='$lastname', Sbirthdate='$birthdate', Sgender='$gender', Spreferredname='$preferredname', Smaxunit='$maxunits', Snationality='$nationality'
WHERE Sandrewid='$AndrewID' ";
