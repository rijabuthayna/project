...
<br/>
Section Key: <input type="text" style="height:25px;" name="SectionKey"> 
<br/>
...
$sql = "SELECT * FROM teaches WHERE PandrewID='".$_POST['AndrewID']."'";
...
<font size='4'>
 ...
 echo"
  ...
  <th>
<form method='POST' action='DeleteTeaching.php'> 
<input type='hidden' name='AndrewID' value=".$row['PandrewID'].">
<input type='hidden' name='Skey' value=".$row['Skey'].">
...
echo "<br>This professor does not teach anything at the moment";
}
?>
<br>
<br>
