...
echo"
  <tr>
   ...
   <th>".$row['Dnumber']."</th>
  <th>
<form method='POST' action='AdminProfProfile.php'> 
...
<input type='submit' class='b1' value='View'> 
  ...
  <th>
<form method='POST' action='AdminEditProf.php'> 
<input type='hidden' name='AndrewID' value=".$row['PandrewID'].">
<input type='submit' class='b1' value='Edit'> 
  ...
  <th>
<form method='POST' action='ProfDelete.php'> 
<input type='hidden' name='AndrewID' value=".$row['PandrewID'].">
...
echo "<br>We do not have any professors currently";
}
?>
<br>
<br>
