...
<form method='POST' action="AddAdminFS.php"> 
AndrewID: <input type="text" style="height:25px;" name="AndrewID"> 
<br/>
Password:	 <input type="text" style="height:25px;" name="password"> 
<br/>
