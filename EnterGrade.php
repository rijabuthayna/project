...
<h3>Enter Grade Form </h3>



<form method='POST' action="EnterGradeFormScript.php" > 
Andrew ID:
<input type="text" style="height:25px;" name="AndrewID"> 
<br/>
Course ID: 
<input type="text" style="height:25px;" name="CourseID"> 
<br/>

Grade or pass/fail: <select name="GOPF">
