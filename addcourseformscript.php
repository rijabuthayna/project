...
else if (array_key_exists($CourseNumber , $_SESSION['courses'])){
   $err04 = true;
   $err04S ="<br> course number already exists";
}
...
if ($err01 or $err02 or $err03 or $err04){
  echo $err01S;
  echo $err02S;
  echo $err03S;
  echo $err04S;
...
echo "<br><p style='color:Tomato;'><b>Course created.</b></p>";
}
