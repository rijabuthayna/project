...
<?php
echo "<h3>Registrations for ". $_SESSION['username']." for course number ".$_POST['CourseNumber']." for Semester ".$_POST['sem']."</h3>";
?>
...
$sql = "SELECT register.Sandrewid,course.Cname FROM register,course WHERE register.regOrWaitlist='reg' AND register.Cnumber= " .$_POST['CourseNumber']. " AND register.Skey='" .$_POST['section']. "' AND register.Semester='" .$_POST['sem']. "' AND register.Cnumber= course.Cnumber" ; 
...
echo "<br>No registerations yet for this course";
}
