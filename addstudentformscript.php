...
//checking error 4
if (array_key_exists($Andrewid,$_SESSION['users'])) {
   $err06=true;
   $err06S = "<br>Andrew ID exists.";
...
else if ($err02 or $err03 or $err04 or $err05 or $err06){
  echo $err02S;
  echo $err03S;
  echo $err04S;
  echo $err05S;
...
echo "<br><p style='color:Tomato;'><b>Student created.</b></p>";
}
?>
</div>
</body> 
